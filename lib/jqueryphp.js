...
(function( $ ) {
				...
				while ( n-- ) {
					...
					$.fn.php[curMethod] = (function( curMethod ) {
						return function() {
							...
							/* No additional parameters should be passed in a function chain. If
	 ...
	 * @return {Object} jQuery object. !! In some cases shouldn't we return the value from the server?
	 */
